...
var DOMAIN_BLOB_SIDECAR = BLSDomainType{0x0B, 0x00, 0x00, 0x00}
...
type Config struct {
	...
	MESSAGE_DOMAIN_INVALID_SNAPPY      BLSDomainType `yaml:"MESSAGE_DOMAIN_INVALID_SNAPPY" json:"MESSAGE_DOMAIN_INVALID_SNAPPY"`
	MESSAGE_DOMAIN_VALID_SNAPPY        BLSDomainType `yaml:"MESSAGE_DOMAIN_VALID_SNAPPY" json:"MESSAGE_DOMAIN_VALID_SNAPPY"`
